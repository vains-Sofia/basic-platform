...
(
    ...
    `albums`         JSON                                                  DEFAULT NULL COMMENT '商家相册URL数组',
    `business_hours` JSON                                                  DEFAULT NULL COMMENT '营业时间设置',
    `description`    VARCHAR(512) NOT NULL                                 DEFAULT '' COMMENT '门店描述',
    `status`         VARCHAR(10)  NOT NULL                                 DEFAULT 'Y' COMMENT 'N-停业 Y-营业中',
